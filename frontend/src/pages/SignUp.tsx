        ...
        <div className="min-h-screen flex">
            <div className="flex-1 flex items-center justify-center p-6 bg-white">
                <div className="w-full max-w-xs lg:max-w-sm">
                    ...
                    {/* Dynamic header based on OTP state */}
                    <div className="text-left mb-6">
                        <h2 className="text-xl font-bold text-gray-900 mb-1">
                            {showOTP ? 'Verify OTP' : 'Sign up'}
                        </h2>
                        <p className="text-gray-500 text-xs">
                            {showOTP ? 'Please enter the OTP sent to your email' : 'Sign up to enjoy the feature of HD'}
                        </p>
                    </div>
                    ...
                    {showOTP ? (
                        ...
                        <form onSubmit={handleOTPSubmit} className="space-y-4">
                            ...
                            <div className="text-center mt-4">
                                <button type="button" onClick={() => setShowOTP(false)} className="text-blue-600 hover:text-blue-700 text-xs">
                                    Back to signup
                                </button>
                            </div>
                        </form>
                        ...
                        <>
                            ...
                            <div className="mt-4">
                                ...
                                }} className="mt-3 w-full flex items-center justify-center px-3 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition text-xs">
