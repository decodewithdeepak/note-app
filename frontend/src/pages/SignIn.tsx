                ...
                <div className="w-full max-w-xs lg:max-w-sm">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="relative group">
                            ...
                            <input id="password" name="password" type={showPassword ? "text" : "password"} value={formData.password} onChange={handleInputChange} className="w-full px-3 py-2 text-sm border-2 border-gray-300 rounded-lg focus:ring-0 focus:border-blue-500 hover:border-blue-500 focus:outline-none pr-10 transition-colors" placeholder="Enter your password" required />
                            <button
                                type="button"
